...
\noindent donde $\mathbf{x} \in \mathbb{R}^n$ (o una variedad diferenciable, como $SE(3)$) representa el estado del sistema, y $r(\mathbf{x})$ es un vector de residuos que mide la diferencia entre las observaciones empíricas y las predicciones generadas por el modelo.
...
\noindent que se minimiza cuando
...
\noindent dando lugar a un paso de 
...
\noindent donde la incógnita $d_k$ será la dirección.
